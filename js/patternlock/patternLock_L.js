...
;(function (factory) {
    ...
    function readyDom(iObj) {
        ...
        for (var i = 0, ln = matrix[0] * matrix[1]; i < ln; i++) {
            html.push('<li id="index' + i + '" class="patt-circ" style="margin:' + margin + 'px; width : ' + (radius * 2) + 'px; height : ' + (radius * 2) + 'px; -webkit-border-radius: ' + radius + 'px; -moz-border-radius: ' + radius + 'px; border-radius: ' + radius + 'px; background-color:#00d6c6;"><div class="patt-dots"></div></li>');
        }
        html.push('</ul>');
